...
export const LEVELS = [
  {
    id: 1,
    name: "そうさになれよう",
    hint: "やること: 矢印キー/WASD(または下の十字ボタン)で移動。箱📦に向かって進むと押せるよ。箱を黄色い目的地まで運ぼう。",
    rows: ["#######", "#.....#", "#.1.2.#", "#..B..#", "#..T..#", "#######"],
  },
  {
    id: 2,
    name: "きょうりょくのとびら",
    hint: "やること: スイッチ◆に誰かが乗っている間だけ扉が開く。ひとりがスイッチの上で待ち、もうひとりが箱を扉の先まで運ぼう。",
    rows: ["#########", "#...#.2.#", "#.1BA..T#", "#...#.a.#", "#########"],
  },
  {
    id: 3,
    name: "ふたつのはこ",
    hint: "やること: 扉は同じ記号どうしで連動するよ。ひとりがスイッチを踏んでいる間に、もうひとりがふたつの箱を運びきろう。",
    rows: [
      "#########",
      "#...#.2.#",
      "#.1BA..T#",
